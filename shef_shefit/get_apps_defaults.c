...
{static char rcs_id1[] = "$Source: /fs/hseb/ob5/rfc/util/src/util_gen1/RCS/get_apps_defaults.c,v $";
 static char rcs_id2[] = "$Id: get_apps_defaults.c,v 1.7 2001/06/13 08:39:14 mgm Exp $";}
/*  ===================================================  */
