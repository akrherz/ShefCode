...
C    ================================= RCS keyword statements ==========
      ...
      DATA             RCSKW1,RCSKW2 /                                 '
     .$Source: /fs/hseb/ob72/ohd/ofs/src/shefpars_driv/RCS/sh2loc.f,v $
     . $',                                                             '
     .$Id: sh2loc.f,v 1.5 2007/02/20 17:37:28 jgofus Exp $
     . $' /
C    ===================================================================
C

C      ITABLE(1,I) IS THE CHANGE OVER DATE IN APRIL/MARCH TO DAYLIGHT TIME.
C      ITABLE(2,I) IS THE CHANGE OVER DATE IN OCTOBER/NOV. TO STANDARD TIME.
